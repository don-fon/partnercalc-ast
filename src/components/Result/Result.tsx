...
export function Result() {
    ...
    useEffect(() => {
        const simulate = async () => {
            ...
            const simulator = new Simulator(parser, astrologian, statOverrides, damageCalculationMode)
    ...
    }, [asyncThrow, damageCalculationMode, parser, searchParams, setReady, setWindows])
